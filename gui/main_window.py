...
class MainWindow(QMainWindow):
    ...
    def generate_image(self):
        ...
        # Ensure output path is set for command building
        if 'output_path' not in params or not params['output_path']:
            # Use a temporary output path for command display
            # The actual path will be generated by ImageGenerator
            cache_dir = self.config.get_cache_dir()
            params['output_path'] = str(cache_dir / "images" / "color_image.tif")
